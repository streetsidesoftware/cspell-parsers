...
describe('python-strings-comments parser', () => {
  ...
  describe('createParser', () => {
    ...
    it('defaults to the "python-strings-comments" name and keeps everything when called with no options', () => {
      const customized = createParser();
      expect(customized.name).toBe('python-strings-comments');

      const parsedTexts = [...customized.parse(content, 'file.py').parsedTexts];
