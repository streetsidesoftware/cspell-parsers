...
/**
 * Returns a version of {@link plugin} to register instead: rename its parser and/or choose which tagged
 * segments get spell checked. This filtering works with any cspell version.
 *
 * **`cspell.config.mjs`**
 *
 * ```js
