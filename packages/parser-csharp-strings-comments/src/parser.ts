...
const STRING_VERBATIM_TAG: ParsedTags = Object.freeze({ ...STRING_TAG, 'string.verbatim': true });
const STRING_INTERPOLATED_TAG: ParsedTags = Object.freeze({ ...STRING_TAG, 'string.interpolated': true });
const STRING_VERBATIM_INTERPOLATED_TAG: ParsedTags = Object.freeze({
  ...STRING_TAG,
  'string.verbatim': true,
  'string.interpolated': true,
});
const STRING_RAW_TAG: ParsedTags = Object.freeze({ ...STRING_TAG, 'string.raw': true });
const STRING_RAW_INTERPOLATED_TAG: ParsedTags = Object.freeze({
  ...STRING_TAG,
  'string.raw': true,
  'string.interpolated': true,
});
