...
| [`@cspell/parser-javascript`](packages/parser-javascript)                                   | `javascript`, `javascriptreact`                                                                                                             | `comment`, `identifier`, `module`<br>`string` |
...
| [`@cspell/parser-strings-comments`](packages/parser-strings-comments)                       | `c`, `cpp`, `csharp`, `go`, `java`<br>`javascript`, `javascriptreact`<br>`php`, `python`, `ruby`, `rust`<br>`typescript`, `typescriptreact` | `comment`, `html`, `module`<br>`string`       |
| [`@cspell/parser-typescript`](packages/parser-typescript)                                   | `javascript`, `javascriptreact`<br>`typescript`, `typescriptreact`                                                                          | `comment`, `identifier`, `module`<br>`string` |
...
| [`@cspell/parser-typescript-tree-sitter`](packages/parser-typescript-tree-sitter)           | `javascript`, `javascriptreact`<br>`typescript`, `typescriptreact`                                                                          | `comment`, `identifier`, `module`<br>`string` |
| [`@cspell/parser-typescript-tree-sitter-wasm`](packages/parser-typescript-tree-sitter-wasm) | `javascript`, `javascriptreact`<br>`typescript`, `typescriptreact`                                                                          | `comment`, `identifier`, `module`<br>`string` |
