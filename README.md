...
| [`@cspell/parser-javascript`](packages/parser-javascript)                                   | `javascript`<br>`javascriptreact`                                                                                                               | `comment`, `identifier`, `module`, `string` |
...
| [`@cspell/parser-strings-comments`](packages/parser-strings-comments)                       | `c`, `cpp`, `csharp`, `go`<br>`java`, `javascript`<br>`javascriptreact`, `php`<br>`python`, `ruby`, `rust`<br>`typescript`<br>`typescriptreact` | `comment`, `html`, `module`, `string`       |
| [`@cspell/parser-typescript`](packages/parser-typescript)                                   | `javascript`<br>`javascriptreact`<br>`typescript`<br>`typescriptreact`                                                                          | `comment`, `identifier`, `module`, `string` |
...
| [`@cspell/parser-typescript-tree-sitter`](packages/parser-typescript-tree-sitter)           | `javascript`<br>`javascriptreact`<br>`typescript`<br>`typescriptreact`                                                                          | `comment`, `identifier`, `module`, `string` |
| [`@cspell/parser-typescript-tree-sitter-wasm`](packages/parser-typescript-tree-sitter-wasm) | `javascript`<br>`javascriptreact`<br>`typescript`<br>`typescriptreact`                                                                          | `comment`, `identifier`, `module`, `string` |
