...
| [`@cspell/parser-strings-comments`](packages/parser-strings-comments)                       | `c`, `cpp`, `csharp`, `go`, `java`<br>`javascript`, `javascriptreact`, `php`<br>`python`, `ruby`, `rust`, `typescript`<br>`typescriptreact` | `comment`, `html`, `module`, `string`       |
| [`@cspell/parser-typescript`](packages/parser-typescript)                                   | `javascript`, `javascriptreact`<br>`typescript`, `typescriptreact`                                                                          | `comment`, `identifier`, `module`, `string` |
...
| [`@cspell/parser-typescript-tree-sitter`](packages/parser-typescript-tree-sitter)           | `javascript`, `javascriptreact`<br>`typescript`, `typescriptreact`                                                                          | `comment`, `identifier`, `module`, `string` |
| [`@cspell/parser-typescript-tree-sitter-wasm`](packages/parser-typescript-tree-sitter-wasm) | `javascript`, `javascriptreact`<br>`typescript`, `typescriptreact`                                                                          | `comment`, `identifier`, `module`, `string` |
