...
| [`@cspell/parser-javascript`](packages/parser-javascript)                                   | `javascript`, `javascriptreact`                                                                                                       | `comment`, `identifier`, `module`, `string` |
...
| [`@cspell/parser-strings-comments`](packages/parser-strings-comments)                       | `c`, `cpp`, `csharp`, `go`, `java`, `javascript`, `javascriptreact`, `php`, `python`, `ruby`, `rust`, `typescript`, `typescriptreact` | `comment`, `html`, `module`, `string`       |
| [`@cspell/parser-typescript`](packages/parser-typescript)                                   | `javascript`, `javascriptreact`, `typescript`, `typescriptreact`                                                                      | `comment`, `identifier`, `module`, `string` |
| [`@cspell/parser-typescript-strings-comments`](packages/parser-typescript-strings-comments) | `javascript`, `javascriptreact`, `typescript`, `typescriptreact`                                                                      | `comment`, `module`, `string`               |
| [`@cspell/parser-typescript-tree-sitter`](packages/parser-typescript-tree-sitter)           | `javascript`, `javascriptreact`, `typescript`, `typescriptreact`                                                                      | `comment`, `identifier`, `module`, `string` |
| [`@cspell/parser-typescript-tree-sitter-wasm`](packages/parser-typescript-tree-sitter-wasm) | `javascript`, `javascriptreact`, `typescript`, `typescriptreact`                                                                      | `comment`, `identifier`, `module`, `string` |
