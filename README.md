...
| [`@cspell/parser-javascript`](packages/parser-javascript)                                   | `javascript`<br>`javascriptreact`                                                                                                               | `comment`, `identifier`<br>`module`, `string` |
| [`@cspell/parser-php-strings-comments`](packages/parser-php-strings-comments)               | `php`                                                                                                                                           | `comment`, `html`, `string`                   |
...
| [`@cspell/parser-strings-comments`](packages/parser-strings-comments)                       | `c`, `cpp`, `csharp`, `go`<br>`java`, `javascript`<br>`javascriptreact`, `php`<br>`python`, `ruby`, `rust`<br>`typescript`<br>`typescriptreact` | `comment`, `html`, `module`<br>`string`       |
| [`@cspell/parser-typescript`](packages/parser-typescript)                                   | `javascript`<br>`javascriptreact`<br>`typescript`<br>`typescriptreact`                                                                          | `comment`, `identifier`<br>`module`, `string` |
| [`@cspell/parser-typescript-strings-comments`](packages/parser-typescript-strings-comments) | `javascript`<br>`javascriptreact`<br>`typescript`<br>`typescriptreact`                                                                          | `comment`, `module`, `string`                 |
| [`@cspell/parser-typescript-tree-sitter`](packages/parser-typescript-tree-sitter)           | `javascript`<br>`javascriptreact`<br>`typescript`<br>`typescriptreact`                                                                          | `comment`, `identifier`<br>`module`, `string` |
| [`@cspell/parser-typescript-tree-sitter-wasm`](packages/parser-typescript-tree-sitter-wasm) | `javascript`<br>`javascriptreact`<br>`typescript`<br>`typescriptreact`                                                                          | `comment`, `identifier`<br>`module`, `string` |
